...
# The script also compares the approach of Hedvigs/rgrambank to that of grambank/grambank-analysed (release paper).
...
# the working directory should be set to rgrambank/example_scripts, the location of this file.
...
joined %>% 
  ...
  theme_classic() +
  labs(x = "Fusion (rgrambank)", y = "Fusion (grambank-analysed)") +
...
joined %>% 
  ...
  theme_classic() +
  labs(x = "Informativity (rgrambank)", y = "Informativity (grambank-analysed)") +
  ggpubr::stat_cor(method = "pearson", p.digits = 2, geom = "label", color = "blue",
                   label.y.npc="top", label.x.npc = "left", alpha = 0.8) 
