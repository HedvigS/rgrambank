...
| :x: |combine_Glottolog_ValueTable_LanguageTable.R|Combines ValueTable and LanguageTable of glottolog-cldf in a practical manner useful for many Grambank analysis purposes| [example_enrich_language_table.R](https://github.com/HedvigS/R_grambank_cookbook/blob/main/example_scripts/example_enrich_language_table.R) |Hedvig Skirgård| [PR 17](https://github.com/dlce-eva/papers/pull/17)
| :x: |add_family_name_column.R| Adds the column "Family_name" to a LanguageTable, using Family_ID and Name. | [example_enrich_language_table.R](https://github.com/HedvigS/R_grambank_cookbook/blob/main/example_scripts/example_enrich_language_table.R) |Hedvig Skirgård| [PR 17](https://github.com/dlce-eva/papers/pull/17)
| :x: |add_isolate_info.R|Marks dialects of isolates as isolates as well in the column "Is_Isolate" and fills in Family_ID.| [example_enrich_language_table.R](https://github.com/HedvigS/R_grambank_cookbook/blob/main/example_scripts/example_enrich_language_table.R)|Hedvig Skirgård|[PR 17](https://github.com/dlce-eva/papers/pull/17)
