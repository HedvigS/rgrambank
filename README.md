...
| 🟡 |✅|make_multistate_ValueTable.R|Takes the GrambankValueTable and transforms binarised feature values into multistate counter parts appropraitely.||Hedvig Skirgård|in progress|Aditya Khan|
