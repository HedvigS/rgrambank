...
| :x: |combine_Glottolog_ValueTable_LanguageTable.R|Combines ValueTable and LanguageTable of glottolog-cldf in a practical manner useful for many Grambank analysis purposes||Hedvig Skirgård| 
| :x: |add_family_name_column.R| Adds the column "Family_name" to a LanguageTable, using Family_ID and Name. ||Hedvig Skirgård| 
| :x: |add_isolate_info.R|Marks dialects of isolates as isolates as well in the column "Is_Isolate" and fills in Family_ID.||Hedvig Skirgård|
